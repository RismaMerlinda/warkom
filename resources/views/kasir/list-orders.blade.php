        ...
        @forelse($orders as $order)
            <div class="bg-white p-6 rounded-xl shadow-md mb-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    ...
                    <span class="mt-2 sm:mt-0 text-sm font-medium px-3 py-1.5 rounded-full bg-green-100 text-green-600 flex items-center">
                ...
                <div class="mt-4">
                    <form action="{{ route('kasir.proses-pembayaran', $order->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
